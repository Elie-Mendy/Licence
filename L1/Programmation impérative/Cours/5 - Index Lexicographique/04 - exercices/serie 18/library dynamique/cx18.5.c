...
gcc -Wall -fpic -shared cx18.5.l.c -o essai.so              // creation biblioteque dynamique
gcc -Wall cx18.5.c essai.so  -o essaye                      // generation de l'executable
LD_LIBRARY_PATH=. essaye                                    // lancement executable
*/
