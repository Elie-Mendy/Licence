...
int main(int k, char  *argv[]) {
  ...
  } while ((strcasecmp(PC , "00")) && i++ <= 150);  // fin du programme quand on jump sur 00 
...
//TODO Nettoyage commentaire 
  // - phases 1

//TODO Gestion erreur saisie
  // - saisie d'une adresse memoire
  // - siasie d'une taille de programme
